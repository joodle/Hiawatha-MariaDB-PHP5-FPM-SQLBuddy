...
apt-get install mariadb-server -y;apt-get install libxslt1.1 -y;wget http://files.tuxhelp.org/hiawatha/hiawatha_9.11-1_amd64.deb;dpkg -i hiawatha_9.11-1_amd64.deb;apt-get install php5 php-pear php5-common php5-curl php5-mysql php5-fpm php5-gd -y;apt-get install unzip -y
